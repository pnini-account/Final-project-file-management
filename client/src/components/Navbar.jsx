...
const pagesRouts = ['home','AddFile','ReadFile','Categories','Folder','Warning','LogOut'];
const pages = ['HomePage','AddFile','ReadFile','PersonalArea','דוגמא','Warnings','LogOut']
const settings = ['Profil', 'PersonalArea', 'Warnings', 'LogOut'];
